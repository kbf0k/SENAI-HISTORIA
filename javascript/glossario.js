...
//   //   K: "<p><b class='naosei'>KGB:</b> Estado islâmico liderado por um califa, que é visto como o sucessor de Maomé.</p>",
...
document.addEventListener("DOMContentLoaded", function() {
  carregarGlossario('A');  // Carrega o conteúdo para a letra 'A' inicialmente
});

function carregarGlossario(letra) {
  const xhr = new XMLHttpRequest();
  xhr.open("GET", "consultar_glossario.php?letra=" + letra, true);  // Envia para o arquivo PHP com o parâmetro 'letra'
  xhr.onload = function() {
      if (xhr.status === 200) {
          // Atualiza o conteúdo com os resultados retornados pelo PHP
...
document.addEventListener("DOMContentLoaded", function() {
  carregarGlossario('A');  // Carrega o conteúdo para a letra 'A' inicialmente
  // Destacar o botão "A" como ativo
  document.getElementById('botaoA').classList.add('ativo');
});
