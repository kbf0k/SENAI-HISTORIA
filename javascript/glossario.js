...
//   const xhr = new XMLHttpRequest();
//   xhr.open("POST", "inserir_conceito.php", true);
//   xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
//   xhr.onload = function() {
//     if (xhr.status === 200) {
//       alert("Conceito inserido com sucesso!");
//       modal.style.display = "none";
//       carregarGlossario(termo.charAt(0).toUpperCase()); // Atualiza a lista com a letra inicial do conceito
//     } else {
//       alert("Erro ao inserir o conceito.");
//     }
//   };
//   xhr.send(`termo=${encodeURIComponent(termo)}&definicao=${encodeURIComponent(definicao)}`);
// });
